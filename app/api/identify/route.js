...
const SYSTEM = [
  ...
  "- hasFloat: is there a float? A float is a plastic CUP that slides on the main shaft, or a BALL on a pivoting ARM. true/false.",
  "- hasThreadedTail: is there a threaded tail/shank with a nut, for a water pipe to screw onto? true/false.",
  "- hasOverflowTube: is there an open-topped overflow tube? true/false.",
  "- hasSpout: does water pour from a spout? true/false.",
  "THEN, and only then, decide partType - and obey your own observations:",
  "- hasFloat true  => partType MUST be \"toilet inlet valve\". No exceptions. Height and slimness are irrelevant; the float decides it.",
  "- hasFloat false AND hasOverflowTube true AND hasThreadedTail false => \"toilet outlet valve\".",
  "If your observations contradict your instinct, follow the observations.",
  "",
